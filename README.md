...
Beyond modeling and analytics, I have a strong interest in data infrastructure and the architectural foundations that enable scalable, reliable, and high-impact data products. I enjoy working across the entire data lifecycle—from data acquisition and engineering to advanced analytics and intelligent decision systems.
